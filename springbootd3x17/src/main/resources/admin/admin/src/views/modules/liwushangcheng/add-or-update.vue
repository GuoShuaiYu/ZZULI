<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="当地是否有疫情" prop="dangdishifouyouyiqing">
          <el-select :disabled="ro.dangdishifouyouyiqing" v-model="ruleForm.dangdishifouyouyiqing" placeholder="请选择当地是否有疫情">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="当地是否有疫情" prop="dangdishifouyouyiqing">
	      <el-input v-model="ruleForm.dangdishifouyouyiqing"
                placeholder="当地是否有疫情" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootd3x17/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
